...
- The light attack is quick to land, costs a small amount of stamina and does a small amount of damage. If the enemy is doing their own light attack when this lands, theirs is canceled. If the enemy was blocking before you started the light attack, they will lose a small amount of stamina but not take damage. If they were *not* blocking before you started but blocked reactively, they will **counter** your attack, avoiding damage and initiating their own, faster attack. To avoid being hit by the counterattack, you must save before it lands.
